...
function slick_client(e) {
    var t = $(".client-curs");
    t.length > 0 &&
        (t.slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !0, infinite: !0, nextArrow: '<i class="fas fa-angle-right"></i>', prevArrow: '<i class="fas fa-angle-left"></i>', cssEase: "cubic-bezier(.9, .03, .41, .49)", speed: 400 }),
    ...
    if (null !== e) {
        ...
        setTimeout(function () {
            try {
                ...
                new google.maps.Marker({ position: o, animation: google.maps.Animation.BOUNCE, icon: "./static/assets/img/map-marker.png", title: "ASL", map: s });
            } catch (e) {
                console.log(e);
            }
        }, 1e3);
        ...
        data_overlay(),
            ...
            (function () {
                ...
                return {
                    ...
                    showText: function () {
                        return { title: { autoAlpha: 1, x: "0%", scale: 1, rotation: 0, ease: Elastic.easeInOut, yoyo: !0, speed: 1000 }, subtitle: { autoAlpha: 1, y: "0%", ease: Elastic.easeOut } };
                    },
                    hideText: function (e) {
                        let t = "-90%";
                        return e && (t = "90%"), { title: { autoAlpha: 0, x: t, rotation: 8, scale: 1.2, ease: Elastic.easeOut, yoyo: !0, speed: 1000 }, subtitle: { autoAlpha: 0, y: t, ease: Elastic.easeOut } };
                    },
                    ...
                    run: function () {
                        ...
                        let a = new Swiper(".nav-slider", { speed: 1000, autoplay: { delay: 6500, }, slidesPerView: 3, centeredSlides: !0, touchRatio: 0.2, slideToClickedSlide: !0, direction: "vertical", resistanceRatio: 0.65 });
    ...
    function n() {
        ...
        void 0 !== o ? (a = o) : a.top <= 70 && (a = s),
            r.getListener(function (e) {
                ...
                let o = 70;
                void 0 !== a && (o = a.top - 70), n > o ? (l < n ? t.addClass("nav-bg").addClass("hide-nave") : t.removeClass("hide-nave")) : t.removeClass("nav-bg").removeClass("hide-nave"), (l = n);
            });
    }
